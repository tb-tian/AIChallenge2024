...
def segmentation(vid):
    start_processing = False
    for v in all_video:
        if v == vid:
            start_processing = True
        if start_processing:
            file = f"./data-source/videos/{v}.mp4"
...
if __name__ == "__main__":
    # segmentation("L09_V024")
    keyframe_extractor("L06_V029")
    # continue on L06_V029, remember to delete it
